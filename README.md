...
4)შემდეგ გახსენი დოკერი Containers>drupal-master>my_drupal9_project_php> CLI და ჯერ 
drush config-set "system.site" uuid 292ad122-b429-43da-bff8-28b6a4cf89e3
შემდეგ drush -y entity:delete shortcut_set
შემდეგ drush cim -y
5)შემდეგ გადადი დრუპალში და დაამატე კონტენტი სურათით ტიტლით და ტექსტით შემდეგ გაუშვი nextjs-ს
